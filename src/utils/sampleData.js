const horse_data = [
    {name: "Delegate", breed: "Westphalian", age: 10, discipline: "Jumper", prizeMoney: "$2,500"},
    {name: "Romina", breed: "Hanovarian", age: 8, discipline: "Hunter", prizeMoney: "$3,000"},
    {name: "Anastasia", breed: "Selle Francais", age: 15, discipline: "Equitation", prizeMoney: "$0"},
    {name: "Per Se", breed: "Dutch Warmblood", age: 22, discipline: "Hunter", prizeMoney: "$0"},
    {name: "Bohemio Z", breed: "Zangersheide", age: 6, discipline: "Jumper", prizeMoney: "$8,000"},
    {name: "Paradigm", breed: "American Warmblood", age: 12, discipline: "Hunter", prizeMoney: "$5,000"}
];
...
export { horse_data, owner_data, betters_data, horseShows_data };